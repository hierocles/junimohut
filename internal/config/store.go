...
func (s *Store) ModTimesPath() string {
	return filepath.Join(s.dataDir, "mod-times.json")
}
func (s *Store) ModUpdatesPath() string {
	return filepath.Join(s.dataDir, "mod-updates.json")
}
